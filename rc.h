...
#define RC_PWM_MINIMUM_FORWARD_SPEED 48     // min 0 .. max 255 (255 is switc
#define RC_PWM_MOTOR_FORWARD_SPEED_MAX 255  // max 255
#define RC_PWM_MINIMUM_REVERSE_SPEED 48     // min 0 .. max 255 (255 is switc
#define RC_PWM_MOTOR_REVERSE_SPEED_MAX 175  // max 255
